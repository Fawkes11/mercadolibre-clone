...
const CardProduct = () => {
    return (
        <Flex
            ...
            _hover={{
                base: {},
                lg: { boxShadow: "rgba(0, 0, 0, 0.35) 0px 5px 15px" }
        ...
        >
            ...
            >
                ...
                >
                    Soporte Base Celular Tablet Escritorio Ajustable Dos Ejes v1</Text>
                <Text color="#00a650" display={{base: "none", lg: "block"}} fontWeight="semibold" fontSize="sm">Envío gratis</Text>
                <Flex m="8px 0 4px">
                    <Text
